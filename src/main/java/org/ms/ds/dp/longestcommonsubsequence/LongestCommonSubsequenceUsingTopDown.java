...
public class LongestCommonSubsequenceUsingTopDown {
    ...
    public static void main(String[] args) {
        LongestCommonSubsequenceUsingTopDown longestCommonSubsequenceUsingRecursion = new LongestCommonSubsequenceUsingTopDown();
        String s1 = "abcdgh";
        String s2 = "abedfhr";
