...
public class MinimumNoOfDeletionToConvertInPalindrom {
    ...
    public static void main(String[] args) {
        MinimumNoOfDeletionToConvertInPalindrom minimumNoOfDeletionToCOnvertInPalindrom = new MinimumNoOfDeletionToConvertInPalindrom();
        String s1 = "agbcba";
